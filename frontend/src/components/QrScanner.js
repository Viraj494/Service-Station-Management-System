                    ...
                    <div className="container">
                        ...
                        {loading ? (
                            ...
                            <form onSubmit={handleDelete}>
                                ...
                                <div className="mb-3 text-white">
                                    <label for="age" className="form-label">Employee Department: {employee.employee.department}</label>
                                </div>
                
                                <div className="mb-3 text-white">
                                    <label for="gender" className="form-label">Employee Contact Nmber: {employee.employee.conactNum}</label>
                                </div>
